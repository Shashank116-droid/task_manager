      ...
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: Theme.of(context).colorScheme.copyWith(primary: AppColors.primaryLight),
          ),
          child: child!,
        );
      },
  ...
  Future<void> _handleSubmit() async {
    ...
    if (mounted) {
      ...
      if (success) {
        ...
        SnackBarHelper.showSuccess(context, isEditing ? 'Task updated!' : 'Task added!');
      } else {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(isEditing ? AppStrings.editTask : AppStrings.addTask, style: Theme.of(context).textTheme.headlineSmall),
                ...
                InkWell(
                  ...
                  child: InputDecorator(
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.calendar_today_rounded, size: 20, color: Theme.of(context).colorScheme.primary),
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                    ),
                    child: Text(DateHelper.formatDate(_selectedDate), style: Theme.of(context).textTheme.bodyLarge),
                  ),
                ),
